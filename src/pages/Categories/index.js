                    ...
                    {(Array.isArray(data) && data.length > 0) && data.map((category, index) => {
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            <Button onClick={() => history.push(`/add-categories/${category.categoryId}/edit`)}>
                              <i className="fa fa-pencil"></i> Edit Category
                            </Button>
                          </td>
                          ...
                          <td>
                            <button
                              type="button"
                              onClick={() =>
                                history.push(`/add-categories/${post.postId}/edit`)
                              }
                              className="btn btn-outline-primary  my-2  mx-1"
                            >
                              <i className="fa fa-pencil"></i> Edit Post1
                            </button>
                          </td>
